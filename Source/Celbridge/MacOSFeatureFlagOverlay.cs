...
/// <summary>
/// A configuration overlay that forces feature flags off on macOS while the macOS port is in
/// progress. It is layered over appsettings.json so the macOS desktop head runs with unported
/// subsystems gated off, while Windows is unaffected (flags default to enabled).
/// </summary>
/// <remarks>
