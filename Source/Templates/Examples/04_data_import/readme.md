...
1. Open **dublinbikes.webview.cel** to view the public bikes available in Dublin city. 
...
5. Open **dublinbikes.xlsx** and check that the number of available bikes matches the data presented in the webview.
