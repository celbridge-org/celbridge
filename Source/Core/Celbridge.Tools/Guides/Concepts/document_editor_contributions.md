...
<div class="cel-section-switcher">
  ...
  <div class="cel-section-area">
    <!-- ... an optional close, ahead of the headers ... -->
    <button class="cel-icon-button cel-section-close" type="button" title="Close" aria-label="Close">
