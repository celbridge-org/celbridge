...
- Landmark identifiers use the `landmark.` prefix and are culture-invariant (for example `landmark.explorer`, `landmark.console`). They are not the panel's display name.
