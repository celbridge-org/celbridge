...
- `namedRanges` may include Excel-internal names prefixed with `_xlnm.` (e.g. `_xlnm._FilterDatabase` generated by an auto-filter). These are not user-defined names; filter them out when iterating.
