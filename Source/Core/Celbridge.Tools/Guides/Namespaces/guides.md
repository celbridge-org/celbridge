...
- **Re-fetch only after a context compaction.** `guides_read` exists for the case where the host context has auto-compacted and a guide that was attached earlier has scrolled out.
