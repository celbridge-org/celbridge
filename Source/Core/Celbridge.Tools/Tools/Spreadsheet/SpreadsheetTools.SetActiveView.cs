...
public partial class SpreadsheetTools
{
    ...
    /// <param name="topLeftCell">A1 single cell to anchor at the upper-left of the visible viewport on the target sheet. Empty string leaves the scroll position unchanged. Must be a single cell, not a range. Note: scroll position is best-effort — Excel and other host applications may reset it on open, and a subsequent spreadsheet_get_active_view may report a different topLeftCell than the one written.</param>
