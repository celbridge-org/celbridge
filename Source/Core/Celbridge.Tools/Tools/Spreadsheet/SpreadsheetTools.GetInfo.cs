...
public partial class SpreadsheetTools
{
    ...
    /// <returns>JSON object with: sheets (array of {name, position, usedRange, rowCount, columnCount}), namedRanges (array of {name, refersTo, scope}). position is the 1-based tab position. usedRange is null for empty sheets.</returns>
