...
internal static class PackageHistoryHelper
{
    ...
    {
        return PackageHistoryReader.TryReadInstalledVersion(historyMarkdown);
    }

    /// <summary>
    /// Reads the package and version named by the newest HISTORY.md entry. Returns null when there is no
    /// parseable heading.
    /// </summary>
    public static InstalledPackageReference? TryReadInstalledReference(string historyMarkdown)
    {
        return PackageHistoryReader.TryReadInstalledReference(historyMarkdown);
    }
