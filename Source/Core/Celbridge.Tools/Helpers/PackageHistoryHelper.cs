...
/// </summary>
internal sealed record InstalledPackageReference(string Name, int Version);
...
internal static class PackageHistoryHelper
{
    ...
    /// heading on the first non-empty line. Returns null when there is no parseable heading (e.g. a
    /// hand-authored file).
    /// </summary>
