...
/// <summary>
/// One entry in an IClearRangesCommand batch. Each operation targets a
...
/// <summary>
/// Result populated by IClearRangesCommand on success. OperationsApplied
...
/// open/save cycle. Unlike IDeleteRangesCommand, clearing does not shift
/// remaining cells — the cleared range is simply emptied in place. Sheet
/// identity (tab name, position, color, frozen panes, named ranges, column
/// widths, row heights) is preserved when an entire sheet is cleared. If any
