...
/// total count of top-level FormatSpec fields summed across edits.
/// AutoFitApplied is true when at least one edit triggered AdjustToContents.
/// </summary>
public record FormatRangesResult(
    int EditsApplied,
    int PropertiesApplied,
    bool AutoFitApplied);

/// <summary>
/// Applies a batch of FormatEdits to one workbook in a single
...
/// </summary>
public interface IFormatRangesCommand : IExecutableCommand<FormatRangesResult>
{
    /// <summary>
    ...
    /// </summary>
    IReadOnlyList<FormatEdit> Edits { get; set; }
}
