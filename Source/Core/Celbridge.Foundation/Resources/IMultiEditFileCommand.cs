...
/// shape as IEditFileCommand's parameters.
/// </summary>
...
/// </summary>
public record MultiEditFileAffectedRange(int EditIndex, int FromLine, int ToLine, int MatchCount = 1);
...
/// threshold.
/// </summary>
public record MultiEditFileEditSummary(int MatchCount, bool Truncated);

/// <summary>
/// Result returned by IMultiEditFileCommand. AppliedCount is the number of
...
/// </summary>
public record MultiEditFileResult(
    int AppliedCount,
    IReadOnlyList<MultiEditFileEditSummary> Edits,
    IReadOnlyList<MultiEditFileAffectedRange> AffectedRanges);
...
/// write.
/// </summary>
public interface IMultiEditFileCommand : IExecutableCommand<MultiEditFileResult>
{
    /// <summary>
