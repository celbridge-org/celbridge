...
public sealed partial class HomeView : UserControl
{
    ...
    private string CelbridgeString => _stringLocalizer.GetString("Home_Celbridge");
    private string CelbridgeTooltipString => _stringLocalizer.GetString("Home_CelbridgeTooltip");
