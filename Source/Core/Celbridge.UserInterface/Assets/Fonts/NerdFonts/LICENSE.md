...
| --- | --- | --- |
| `cod-` | Codicons | CC BY 4.0 |
| `dev-` | Devicons | MIT |
| `fa-` | Font Awesome Free | Icons CC BY 4.0, fonts SIL OFL 1.1 |
| `fae-` | Font Awesome Extension | MIT |
| `iec-` | IEC Power Symbols | Public domain |
| `linux-` | Font Logos | MIT |
| `md-` | Material Design Icons | Pictogrammers Free License |
| `oct-` | Octicons | MIT, Copyright (c) 2023 GitHub Inc. |
| `pl-` | Powerline Symbols | MIT, Copyright 2013 Kim Silkebaekken and contributors |
| `ple-` | Powerline Extra Symbols | MIT, Copyright (c) 2016 Ryan L McIntyre |
| `pom-` | Pomicons | SIL OFL 1.1, Copyright (c) 2021 Gabriele Lana |
| `seti-`, `custom-` | Seti UI and Nerd Fonts originals | MIT |
| `weather-` | Weather Icons | SIL OFL 1.1 |
| `extra-`, `indent-`, `indentation-` | Nerd Fonts originals | MIT |
