...
public class PackageToolTests
{
    ...
    [Test]
    public async Task Install_SameNamePackageLoadedAtAnotherPath_IsRefusedBeforeReachingTheWorkshop()
    {
        ...
        var tools = new PackageTools(_services);
        var result = await tools.Install("acme-widget", destination: "lib", confirmWithUser: false);
    ...
    [Test]
    public async Task Install_SameNamePackageWhoseManifestWasDeleted_IsNotRefused()
    {
