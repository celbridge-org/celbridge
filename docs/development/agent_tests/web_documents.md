...
Text fields inside the page, links within it, and the document's own chrome: the find bar and the address
bar.
...
Downloads plan. HTML documents open in the HTML editor, which the [HTML Editor](html_editor.md) plan
covers.
